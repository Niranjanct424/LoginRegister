...
import com.bridgelabz.loginregistration.repository.EmpDao;
...
public class ViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.print("<tr><th>Userid</th><th>Uname</th><th>Email</th><th>Mobile</th><th>Password</th>");
		for (Emp e : list) {
			out.print("<div><tr><td>" + e.getUserid() + "</td><td>" + e.getUname() + "</td><td>" + e.getEmail()
					+ "</td><td></div>" + e.getMobile() + "</td><td>" + e.getPassword() + "</td></tr>");
		}
		out.print("</table>");
